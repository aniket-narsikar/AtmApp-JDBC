package aniket.atm.controller;
import aniket.atm.dto.AtmDto;
import aniket.atm.dao.AtmDao;
...
public class ATMService {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			switch (choice) {
			case 1:
				AtmDto account = readAccountDetails(read);
	...
	private static AtmDto readAccountDetails(Scanner read) {
		...
		return new AtmDto(accountNumber, userName, atmCardNumber, pin, amount);
	}
